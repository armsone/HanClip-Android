...
private fun JSONObject.toWatermarkSettings(): WatermarkSettings {
    return WatermarkSettings(
        ...
        shadowOpacity = optDouble("shadowOpacity", 0.75),
        shadowColorHex = optString("shadowColorHex", "#642BFF"),
        ...
        fontSize = enumValueOrDefault(optString("fontSize"), WatermarkFontSize.ExtraLarge),
