...
- 소스 수정 및 단위시험·빌드·린트 완료: A04, A07, A09, A11, A12, A13, B05, C03, C09, C10, C12, C15, C16, C17, C19, D01, D02, D04, D05, D10, D11, D12, D13, D14, E03, E06, E07, F01, F05, F06.
- SM-F968N에 APK를 설치하고 홈·기존 프로젝트 편집 화면 진입을 확인했다. 실제 미디어 출력 결과와 전체 제스처는 아직 검증하지 않았으므로 해당 항목을 `동일`로 재판정하지 않는다.
